...
// "false" para cada dibujo
MainGame::MainGame() : initTime(0), spriteInitialized{ false, false, false, false, false, false, false, false, false, false, false, false, false, false, false }
{
	window = nullptr;
	width = 800;
	height = 600;
...
void MainGame::update()
{
	while (gameState != GameState::EXIT) {
		...
		// validacion y aparicion por tiempo
		for (int i = 0; i < 15; i++) {
